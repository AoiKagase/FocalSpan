...
Archived files are immutable historical evidence. They describe completed or replaced work and are not active instructions; the repository-root `PLAN.md` is the sole active plan.
