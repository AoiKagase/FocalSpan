...
7. Promote C/C++, C#, and JavaScript/TypeScript to dedicated pure-Go
...
8. Keep container declarations as outline chunks and concrete methods/
...
9. Treat unresolved calls, imports/exports/includes, and references as
