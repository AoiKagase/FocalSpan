...
func TestNewExtractorRegistrySelectsDedicatedExtractors(t *testing.T) {
	...
	tests := []struct {
		...
		{name: "lua", path: "lua/auth.lua", language: "lua", want: "lua-structural"},
		{name: "pawn", path: "addons/amxmodx/scripting/plugin.sma", language: "pawn", want: "pawn-structural"},
		{name: "vb6", path: "legacy/Module1.bas", language: "vb6", want: "vb6-structural"},
		...
		{name: "zig", path: "src/auth.zig", language: "zig", want: "zig-structural"},
